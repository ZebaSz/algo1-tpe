...
\requiere[vuelosDeIgualLargo]{(\forall i \leftarrow [1..\longitud{ds})) \longitud{vueloRealizado(ds_i)} == \longitud{vueloRealizado(ds_{i-1})}}
...
\asegura[enOrden]{(\forall i \leftarrow [1..\longitud{\res})) \sgd{\res_i} \geq \sgd{\res_{i-1}} \vee (\forall i \leftarrow [1..\longitud{\res})) \sgd{\res_i} \leq \sgd{\res_{i-1}}}
\end{problema}
