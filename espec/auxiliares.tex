...
\aux{alOeste}{e,d: Dron}{\bool}{\sgd{posicionActual(e)} == \sgd{posicionActual(d)} + distancia(posicionActual(e), posicionActual(d))}

\aux{unFertilizantePorCultivo}{e,d: Dron}{\bool}{mismos(productosDisponibles(d), productosDisponibles(e) ++ [ Fertilizante | i \leftarrow [0..distancia(posicionActual(d), posicionActual(e))) ])}