...
\aux{alOeste}{e,d: Drone}{\bool}{\sgd{posicionActual(e)} == \sgd{posicionActual(d)} - \longitud{vueloDiferente(e,d)}}

\aux{vueloDiferente}{e,d: Drone}{[(\ent, \ent)]}{[ vueloRealizado(e)_i | i \leftarrow [\longitud{vueloRealizado(d)}..\longitud{vueloRealizado(e)}) ]}

\aux{soloCultivos}{s: Sistema, r: [(\ent,\ent)]}{\bool}{(\forall (i,j) \in r) contenido(campo(s),i,j) == Cultivo}

\aux{unFertilizantePorCultivo}{e,d: Drone}{\bool}{mismos(productosDisponibles(d), productosDisponibles(e) ++ [ Fertilizante | i \leftarrow [0..\longitud{vueloDiferente(e,d)}) ])}