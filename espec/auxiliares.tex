...
\aux{noHaceNada}{e,d: Drone}{\bool}{mismos(productosDisponibles(d),productosDisponibles(e)) \\ \lor bateria(d) -1 == bateria(e)}
...
\aux {losProductosSumanMenosDe100}{d:Drone}{\bool}
{\\ 100 \geq ( \sum [10\ | \ p \leftarrow productosDisponibles(d), p == Plaguicida] + \sum [5\ | \ p \leftarrow productosDisponibles(d), \\ p == PlaguicidaBajoConsumo \lor p == Herbicida \lor p == HerbicidaLargoAlcance])}
...
\aux {estanVolandoAlLado}{d,e:Drone, i:\ent}{\bool}
{(prm(vueloRealizado(d))_i == prm(vueloRealizado(e))_i \implica (sgd (vueloRealizado(d))_i + 1 == sgd (vueloRealizado(e))_i) \lor (sgd (vueloRealizado(d))_i - 1 == sgd (vueloRealizado(e))_i)) \land (sgd(vueloRealizado(d))_i == sgd(vueloRealizado(e))_i \implica (prm (vueloRealizado(d))_i + 1 == prm (vueloRealizado(e))_i) \lor (prm (vueloRealizado(d))_i - 1 == prm (vueloRealizado(e))_i))}
