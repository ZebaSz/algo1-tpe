...
\asegura[cambiosADrones]{(\forall d \in enjambreDrones(\pre{s})) \\ (enVuelo(d) \wedge ((\exists e \in enjambreDrones(s)) id(e) == id(d)  \wedge enVuelo(e) \wedge alOeste(e, d) \\ \wedge bateria(e) == (bateria(d) + \longitud{vueloDiferente(e,d)}) \\ \wedge unFertilizantePorCultivo(e,d))) \wedge soloCultivos(s,vueloDiferente(e,d))  \\ \vee (\neg enVuelo(d) \wedge \en{d,enjambreDrones(s))}}
