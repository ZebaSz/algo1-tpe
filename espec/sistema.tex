...
\asegura[siEstaBienNoHaceNada]{(\exists e \in enjambreDrones(s), id(d) == id(e)) \\ \neg \en{estadoDelCultivo(\pre{s}, \prm{posicionActual(e)}, \sgd{posicionActual(e)}), \ [ConMaleza, ConPlaga, NoSensado]} \\ \implica (noHaceNada(e,d) \land estadoDelCultivo(\pre{s}, \prm{posicionActual(e)}, \sgd{posicionActual(e)}) \\ == estadoDelCultivo(s, \prm{posicionActual(e)}, \sgd{posicionActual(e)}))}
